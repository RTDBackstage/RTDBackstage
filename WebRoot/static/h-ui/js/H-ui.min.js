...
!(function(a) {
	...
	function c(i) {
		...
		try {
			i = decodeURIComponent(i.replace(a, " "));return b.json ? JSON.parse(i) : i
		} catch (j) {}
	}
	function e(j, i) {
		var k = b.raw ? j : c(j);
	...
	f.fn.ajaxSubmit = function(j) {
		...
		this.trigger("form-submit-notify", [ this, j ]);return this;
		function g(K) {
			...
			for (J = 0; J < q; J++) {
				L[J] = L[J].replace(/\+/g, " ");
				I = L[J].split("=");k.push([ decodeURIComponent(I[0]), decodeURIComponent(I[1]) ])
			}
			return k
		}
		function t(q) {
			...
			j.data = null;var K = f.extend(true, {}, f.ajaxSettings, j, {
				contentType : false,
				processData : false,
				cache : false,
				type : i || "POST"
			...
			K.data = null;var J = K.beforeSend;
		...
		function G(af) {
			...
			if (V.iframeTarget) {
				...
				N = f('<iframe name="' + Y + '" src="' + V.iframeSrc + '" />');N.css({
					position : "absolute",
					top : "-1000px",
					left : "-1000px"
				})
			...
			function aa() {
				...
				try {
					...
					L.setAttribute("action", an);L.setAttribute("enctype", ao);
					if (ar) {
			...
			function X(ap) {
				...
				if (ap === U && O) {
					O.abort("timeout");ai.reject(O, "timeout");return
				} else {
					if (ap == R && O) {
						O.abort("server abort");ai.reject(O, "error", "server abort");return
					}
				}
				...
				try {
					...
					if (!am && window.opera && (ah.body === null || !ah.body.innerHTML)) {
						if (--ae) {
							d("requeing onLoad callback, DOM not available");setTimeout(X, 250);return
						}
					}
	...
	f.fn.ajaxForm = function(g) {
		...
		if (!g.delegation && this.length === 0) {
			...
			if (!f.isReady && h.s) {
				d("DOM not ready, queuing ajaxForm");f(function() {
		...
		if (g.delegation) {
			f(document).off("submit.form-plugin", this.selector, b).off("click.form-plugin", this.selector, a).on("submit.form-plugin", this.selector, g, b).on("click.form-plugin", this.selector, g, a);return this
		}
	...
	function b(h) {
		...
		if (!h.isDefaultPrevented()) {
			h.preventDefault();f(h.target).ajaxSubmit(g)
		}
	}
	function a(k) {
		var j = k.target;
	...
	var c = function(e, g) {
		...
		var m = function(z, x) {
			...
			n = this.options;
			j = this.wrapper;this._init(this)
		};
		m.prototype = {
			destroy : function() {
				this._removeStyles();o(j, "closed");o(j, "opened");o(j, n.navClass);o(j, n.navClass + "-" + this.index);o(k, n.navActiveClass);j.removeAttribute("style");j.removeAttribute("aria-hidden");r(d, "resize", this, false);r(d, "focus", this, false);r(a.body, "touchmove", this, false);r(i, "touchstart", this, false);r(i, "touchend", this, false);r(i, "mouseup", this, false);r(i, "keyup", this, false);r(i, "click", this, false);
				if (!n.customToggle) {
			...
			open : function() {
				if (!u) {
					o(j, "closed");l(j, "opened");l(k, n.navActiveClass);l(i, "active");
					j.style.position = n.openPos;s(j, {
						"aria-hidden" : "false"
					});
					u = true;n.open()
				}
			...
			close : function() {
				if (u) {
					l(j, "closed");o(j, "opened");o(k, n.navActiveClass);o(i, "active");s(j, {
						"aria-hidden" : "true"
					});
					if (n.animate) {
						v = false;setTimeout(function() {
			...
			resize : function() {
				if (d.getComputedStyle(i, null).getPropertyValue("display") !== "none") {
					...
					j.style.position = n.openPos;this._removeStyles()
				}
			},
			...
			_init : function() {
				this.index = b++;l(j, n.navClass);l(j, n.navClass + "-" + this.index);l(j, "closed");
				v = true;
				u = false;this._closeOnNavClick();this._createToggle();this._transitions();this.resize();
				var x = this;
				setTimeout(function() {
					x.resize()
				}, 20);q(d, "resize", this, false);q(d, "focus", this, false);q(a.body, "touchmove", this, false);q(i, "touchstart", this, false);q(i, "touchend", this, false);q(i, "mouseup", this, false);q(i, "keyup", this, false);q(i, "click", this, false);n.init()
			},
			_createStyles : function() {
				if (!w.parentNode) {
					w.type = "text/css";a.getElementsByTagName("head")[0].appendChild(w)
				}
			},
			...
			_preventDefault : function(x) {
				if (x.preventDefault) {
					...
					x.preventDefault();x.stopPropagation();return false
				} else {
					x.returnValue = false
				}
			},
			_onTouchStart : function(x) {
				...
				this.touchHasMoved = false;r(i, "mouseup", this, false)
			},
...
}(document, window, 0));!function(h, j, e) {
	...
	if (a && f) {
		...
		l = k.placeholder = function() {
			...
			o.filter((a ? "textarea" : ":input") + "[placeholder]").not(".placeholder").on({
				"focus.placeholder" : c,
				"blur.placeholder" : g
			}).data("placeholder-enabled", true).trigger("blur.placeholder");return o
		};
		l.input = a;
		l.textarea = f;
		m = {
	...
	function c(p, q) {
		...
		if (o.value == r.attr("placeholder") && r.hasClass("placeholder")) {
			if (r.data("placeholder-password")) {
				...
				o.value = "";r.removeClass("placeholder");o == n() && o.select()
			}
		}
	}
	function g() {
...
}(this, document, jQuery);!function(c) {
	var b = "emailsuggest",
		d = {
			sugClass : "emailSug",
	...
	a.prototype = {
		...
		addEvent : function() {
			...
			this.$field.on("keyup.ema", function(g) {
				f = c.trim(this.value);
				if (f) {
					e.create(this, f);e.doSelect(g.keyCode)
				} else {
					e.hide()
				}
		...
		create : function(i, q) {
			...
			o = c('<div class="' + this.options.sugClass + '-wrapper" style="' + f + '" />');n.push('<ul class="' + this.options.sugClass + '-list">');
			k = this.filter(q, this._domains);
			m = k.length;c.each(k, function(t, u) {
			...
			n = n.join("");
			if (this.$suggest) {
				this.$suggest.empty();this.$suggest.append(n)
			} else {
				o.append(n);c("body").append(o);
				this.$suggest = o;this.$suggest.on("mouseenter click", "." + this.options.sugClass + "-item", function(u) {
					var t,
						s;
					s = c(this);
					t = s.parent().children();
					if (u.type === "mouseenter") {
						...
						l.$field.val(t.eq(l.selectedIndex).text());l.hide()
					}
				})
			}
			this.show()
		...
		doSelect : function(h) {
			...
			switch (h) {
			case 13:
				c("li.active", this.$suggest).trigger("click");this.selectedIndex = 0;
				break;case 38:
				this.selectedIndex--;
		...
		filter : function(g, e) {
			...
			i = g.indexOf("@");
			if (i > -1) {
				h = g.substring(i + 1);c.each(e, function(j, k) {
					if (k.indexOf(h) > -1) {
						f.push(k)
					}
				})
	...
	a.fn.Huispinner = function(c, e) {
		...
		this.each(function() {
			...
			var f = g.find(".input-text"),
				...
				h = parseInt(f.val());
			if (h <= c.minValue) {
				j.addClass("disabled");i.removeClass("disabled")
			}
			if (h >= c.maxValue) {
				j.removeClass("disabled");i.addClass("disabled")
			}
			f.on("blur", function() {
				var l = a(this).val();
				l = l.replace(/[^\d]/g, "");
				...
				if (l != "") {
					if (l > c.minValue && l < c.maxValue) {
						f.val(l);i.removeClass("disabled");j.removeClass("disabled")
					} else {
						if (l <= c.minValue) {
							f.val(c.minValue);j.addClass("disabled");i.removeClass("disabled")
						} else {
							f.val(c.maxValue);j.removeClass("disabled");i.addClass("disabled")
						}
					}
				} else {
					a(this).val(c.minValue);j.addClass("disabled");i.removeClass("disabled")
				}
				if (e) {
					e(f.val())
				}
				...
				f.val(l <= c.minValue ? c.minValue : l - c.dis);i.removeClass("disabled");
				if (f.val() <= c.minValue) {
					f.val(c.minValue);j.addClass("disabled")
				}
				if (e) {
					e(f.val())
				}
				...
				var l = parseInt(f.val());
				f.val(l >= c.maxValue ? c.maxValue : l + c.dis);j.removeClass("disabled");
				if (f.val() >= c.maxValue) {
					f.val(c.maxValue);i.addClass("disabled")
				}
				if (e) {
					e(f.val())
				}
	...
	c.fn[g] = function(N, E) {
		...
		if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(N)) {
			N = N.toLowerCase();B(this);return L.each(function() {
				var O = c(this);
				if (N == "destroy") {
					u(O, "ifDestroyed")
				} else {
			...
			if (typeof N == "object" || !N) {
				...
				B(this);return L.each(function() {
					...
					P = c('<ins class="' + e + '"/>').css(T).appendTo(Y);Z.data(g, {
						o : F,
						s : Z.attr("style")
					}).css(U);!!F.inheritClass && Y[p](R.className || "");!!F.inheritID && O && Y.attr("id", g + "-" + O);Y.css("position") == "static" && Y.css("position", "relative");v(Z, true, r);
					if (X.length) {
		...
		if (G[D] !== true) {
			if (!B && D == s && G[t] == a && G.name) {
				var E = K.closest("form"),
					I = 'input[name="' + G.name + '"]';
				I = E.length ? E.find(I) : c(I);I.each(function() {
	...
	function u(B, C) {
		if (B.data(g)) {
			...
			B.off(".i").unwrap();c(z + '[for="' + B[0].id + '"]').add(B.closest(z)).off(".i")
		}
	}
	function m(B, D, C) {
		if (B.data(g)) {
	...
	var a = {
		init : function(c) {
			return this.each(function() {
				var d = this,
					h = b(d).empty();
				d.opt = b.extend(true, {}, b.fn.raty.defaults, c);h.data("settings", d.opt);
				...
				if (d.opt.score && d.opt.score > 0) {
					d.score.val(d.opt.score);a.roundStar.call(d, d.opt.score)
				}
				if (d.opt.iconRange) {
		...
		bindAction : function() {
			...
			e.mouseleave(function() {
				...
				a.initialize.call(c, f);a.setTarget.call(c, f, c.opt.targetKeep);
				if (c.opt.mouseover) {
			...
			if (c.opt.cancel) {
				c.cancel.mouseenter(function() {
					b(this).attr("src", c.opt.path + c.opt.cancelOn);c.stars.attr("src", c.opt.path + c.opt.starOff);a.setTarget.call(c, null, true);
					if (c.opt.mouseover) {
			...
			c.stars.bind(d, function(g) {
				...
				if (c.opt.half) {
					var f = parseFloat((g.pageX - b(this).offset().left) / c.opt.size),
						i = (f > 0.5) ? 1 : 0.5;
					h = parseFloat(this.alt) - 1 + i;a.fill.call(c, h);
					if (c.opt.precision) {
						h = h - i + f
					}
					a.showHalf.call(c, h)
		...
		fixHint : function() {
			...
			c.data("readonly", true).css("cursor", "default").attr("title", d);this.score.attr("readonly", "readonly");this.stars.attr("title", d)
		},
		getScore : function() {
			var d = [],
				c;
			b(this).each(function() {
				c = this.score.val();d.push(c ? parseFloat(c) : undefined)
		...
		readOnly : function(c) {
			return this.each(function() {
				...
				if (c) {
					d.unbind();d.children("img").unbind();a.fixHint.call(this)
				} else {
					a.bindAction.call(this);a.unfixHint.call(this)
				}
				d.data("readonly", c)
			})
		},
		...
		setScore : function(c) {
			return b(this).each(function() {
				...
				a.initialize.call(this, c);a.setTarget.call(this, c, true)
			})
		},
		...
		initialize : function(c) {
			c = !c ? 0 : a.between(c, 0, this.opt.number);a.fill.call(this, c);
			if (c > 0) {
		...
		unfixHint : function() {
			...
			b(this).data("readonly", false).css("cursor", "pointer").removeAttr("title");this.score.attr("readonly", "readonly")
		}
	};
	...
	a.fn.onePageNav = function(b) {
		...
		d.bindNav = function(f, h, i) {
			...
			if (!g.hasClass(i.currentClass)) {
				...
				d.adjustNav(h, g, i.currentClass);j.unbind(".onePageNav");a.scrollTo(e, i.scrollSpeed, {
					easing : i.easing,
					offset : {
						top : -i.scrollOffset
					},
		...
		d.adjustNav = function(g, e, f) {
			g.find("." + f).removeClass(f);e.addClass(f)
		};
		...
		d.init = function(g, h) {
			...
			e.bind("click", function(i) {
				d.bindNav(a(this), g, h);i.preventDefault()
			});d.getPositions(g, h);a(window).bind("scroll.onePageNav", function() {
				f = true
			});setInterval(function() {
				if (f) {
					f = false;d.scrollChange(g, h)
				}
			}, 250)
		};return this.each(function() {
			var e = a(this),
	...
	var c = function(g, f) {
		this.name = b;
		this.$ = e(g);this.getOptions(f);this.init()
	};
	c.DEFAULTS = {
	...
	c.prototype.init = function() {
		var f = this.options,
			h = this;
		this.$picker = e(d).addClass(f.wrapper);this.$picker.find(".cp-title").toggle(f.title !== undefined).text(f.title);
		this.$menu = this.$picker.find(".dropdown-menu").toggleClass("pull-right", f.pullMenuRight);
		this.$btn = this.$picker.find(".btn.dropdown-toggle");this.$btn.find(".ic").addClass("icon-" + f.icon);
		if (f.btnTip) {
		...
		this.colors = {};e.each(this.options.colors, function(j, l) {
	...
	c.prototype.setValue = function(f, i) {
		...
		if (f) {
			...
			h = j.toCssStr().toLowerCase();this.$btn.css({
				background : h,
			...
			this.$menu.find(".cp-tile[data-color=" + h + "]").addClass("active");this.$.tooltip("hide");this.$.trigger("colorchange", j)
		} else {
			...
			this.$menu.find(".cp-tile.empty").addClass("active");this.$.trigger("colorchange", null)
		}
		if (g.updateBorder) {
...
function Huisethome(c) {
	try {
		c.style.behavior = "url(#default#homepage)";c.setHomePage(webSite)
	} catch (b) {
		if (window.netscape) {
			try {
...
function displaynavbar(a) {
	if ($(a).hasClass("open")) {
		$(a).removeClass("open");$("body").removeClass("big-page")
	} else {
		$(a).addClass("open");$("body").addClass("big-page")
	}
}
!function(a) {
	...
	a.fn.Huitab = function(b) {
		...
		this.each(function() {
			var d = a(this);
			d.find(b.tabBar).removeClass(b.className);d.find(b.tabBar).eq(b.index).addClass(b.className);d.find(b.tabCon).hide();d.find(b.tabCon).eq(b.index).show();d.find(b.tabBar).on(b.tabEvent, function() {
				d.find(b.tabBar).removeClass(b.className);a(this).addClass(b.className);
				var e = d.find(b.tabBar).index(this);
				d.find(b.tabCon).hide();d.find(b.tabCon).eq(e).show()
			})
		})
	}
}(window.jQuery);!function(a) {
			...
			d.find(b.titCell).on(b.trigger, function() {
				if (a(this).next().is(":visible")) {
					...
					if (b.type == 3) {
						...
						d.find(b.mainCell).slideUp(b.speed);d.find(b.titCell).removeClass(b.className);
		...
		this.each(function() {
			...
			if (c.tagsDefault) {
				...
				q.find("span").on("click", function() {
					var i = a(this).text();
					i = i.replace(/(^\s*)|(\s*$)/g, "");k.append('<span class="Huitags-token">' + i + "</span>");o(this);a(this).remove()
				})
			}
			function o(t) {
				var u = "";
			...
			p.on("keydown", function(t) {
				...
				if (j.find(".Huitags-token").length < 1) {
					...
					s = s.substring(0, s.length - 1);e.val(s)
				}
			});p.change()
		})
	}
	...
	a.fn.Huitextarealength = function(b) {
		...
		this.each(function() {
			...
			f.parent().append(g);f.on("keyup", function() {
				e = f.val();
				d = e.length;
				if (d > b.maxlength) {
					if (b.exceed) {
						...
						e = e.substring(0, b.maxlength);f.val(e);f.removeClass(b.errorClass)
					}
				} else {
					if (d < b.minlength) {
						f.addClass(b.errorClass)
	...
	a.fn.Huipreview = function(b) {
		...
		this.each(function() {
			...
			d.hover(function() {
				...
				clearTimeout(e);d.removeClass(b.className);a("#preview-wraper").remove()
			})
		})
	}
}(window.jQuery);!function(a) {
	a.Huimodalalert = function(c, b) {
		...
		if (b == 0 || typeof (b) == "undefined") {
			a(document.body).append('<div id="modal-alert" class="modal modal-alert radius">' + '<div class="modal-alert-info">' + c + "</div>" + '<div class="modal-footer"> <button class="btn btn-primary radius" onClick="$.Huimodal_alert.hide()">确定</button></div>' + "</div>");a("#modal-alert").fadeIn()
		} else {
			a(document.body).append('<div id="modal-alert" class="modal modal-alert radius">' + '<div class="modal-alert-info">' + c + "</div>" + "</div>");a("#modal-alert").fadeIn();setTimeout(a.Huimodalalert.hide, b)
		}
	};
	...
	a.Huialert = function() {
		a(".Huialert i").Huihover();a(".Huialert i").on("click", function() {
	...
	a.Huimarquee = function(i, e, f) {
		...
		var g = function() {
			if (c.scrollTop % i != 0) {
				...
				clearInterval(b);setTimeout(d, f)
			}
		};
		setTimeout(d, f)
	}
	...
	b.prototype.setState = function(g) {
		...
		setTimeout(d.proxy(function() {
			...
			if (g == "loadingText") {
				this.isLoading = true;e.addClass(i).attr(i, i)
			} else {
				if (this.isLoading) {
					this.isLoading = false;e.removeClass(i).removeAttr(i)
				}
			}
		}, this), 0)
	};
	...
	d.fn.button.noConflict = function() {
		d.fn.button = a;return this
	};d(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(g) {
		var f = d(g.target);
		if (!f.hasClass("btn")) {
		}
		f = f.closest(".btn");c.call(f, "toggle");g.preventDefault()
	...
	a(document).ready(function() {
		...
		a.fn.stickUp = function(q) {
				...
				for (var o = 0; o < c; o++) {
					...
					function p(q) {
						...
						if (varscroll > testView) {
							a("." + l).removeClass(b);a("." + l + ":eq(" + q + ")").addClass(b)
						} else {
							if (varscroll < 50) {
								a("." + l).removeClass(b);a("." + l + ":eq(0)").addClass(b)
							}
						}
					}
					if (i == "down" && varscroll > n[o] - 50 && varscroll < n[o] + 50) {
						a("." + l).removeClass(b);a("." + l + ":eq(" + o + ")").addClass(b)
					}
					if (i == "up") {
						p(o)
					}
			...
			if (j < varscroll + f) {
				a(".stuckMenu").addClass("isStuck");a(".stuckMenu").next().closest("div").css({
					"margin-top" : m + k + d + "px"
				}, 10);a(".stuckMenu").css("position", "fixed");a(".isStuck").css({
					top : "0px"
				}, 10, function() {})
			}
			if (varscroll + f < j) {
				a(".stuckMenu").removeClass("isStuck");a(".stuckMenu").next().closest("div").css({
					"margin-top" : d + "px"
				}, 10);a(".stuckMenu").css("position", "relative")
			}
		})
	})
});!function(d) {
	...
	b.prototype.show = function(h) {
		...
		this.isShown = true;this.checkScrollbar();this.$body.addClass("modal-open");this.setScrollbar();this.escape();this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', d.proxy(this.hide, this));this.backdrop(function() {
			...
			f.$element.addClass("in").attr("aria-hidden", false);f.enforceFocus();
	...
	b.prototype.hide = function(f) {
		...
		f = d.Event("hide.bs.modal");this.$element.trigger(f);
	...
	b.prototype.measureScrollbar = function() {
		...
		this.$body[0].removeChild(f);return e
	};
	function c(e, f) {
		return this.each(function() {
			var i = d(this);
	...
	function d(i) {
		...
		h(b).each(function() {
			...
			l.attr("aria-expanded", "false");k.removeClass("open").trigger("hidden.bs.dropdown", j)
		})
	}
	...
	var c = function(f, e) {
		this.type = this.options = this.enabled = this.timeout = this.hoverState = this.$element = null;this.init("tooltip", f, e)
	};
	c.VERSION = "3.3.0";
		...
		for (var h = k.length; h--;) {
			...
			if (f == "click") {
				...
				if (f != "manual") {
					...
					this.$element.on(m + "." + this.type, this.options.selector, d.proxy(this.enter, this));this.$element.on(e + "." + this.type, this.options.selector, d.proxy(this.leave, this))
				}
			}
		}
	...
	c.prototype.enter = function(f) {
		...
		if (e && e.$tip && e.$tip.is(":visible")) {
			e.hoverState = "in";return
		}
		if (!e) {
			e = new this.constructor(f.currentTarget, this.getDelegateOptions());d(f.currentTarget).data("bs." + this.type, e)
		}
	...
	c.prototype.show = function() {
		...
		if (this.hasContent() && this.enabled) {
			...
			this.setContent();m.attr("id", i);this.$element.attr("aria-describedby", i);
			...
			if (u) {
				...
				l = l == "bottom" && r.bottom + n > h.bottom ? "top" : l == "top" && r.top - n < h.top ? "bottom" : l == "right" && r.right + f > h.width ? "left" : l == "left" && r.left - f < h.left ? "right" : l;m.removeClass(k).addClass(l)
			}
	...
	c.prototype.applyPlacement = function(j, k) {
		...
		j.top = j.top + f;
		j.left = j.left + i;d.offset.setOffset(l[0], d.extend({
			using : function(r) {
				l.css({
		...
		l.offset(j);this.replaceArrow(h, l[0][o], n)
	};
	...
	c.prototype.setContent = function() {
		var f = this.tip();
		var e = this.getTitle();
		f.find(".tooltip-inner")[this.options.html ? "html" : "text"](e);f.removeClass("fade in top bottom left right")
	};
	c.prototype.hide = function(j) {
		...
		function f() {
			...
			g.$element.removeAttr("aria-describedby").trigger("hidden.bs." + g.type);j && j()
		}
		...
		this.hoverState = null;return this
	};
	...
	c.prototype.getTitle = function() {
		...
		var e = this.$element;
		var f = this.options;
		g = e.attr("data-original-title") || (typeof f.title == "function" ? f.title.call(e[0]) : f.title);return g
	};
	...
	c.prototype.toggle = function(g) {
		...
		if (g) {
			...
			if (!f) {
				f = new this.constructor(g.currentTarget, this.getDelegateOptions());d(g.currentTarget).data("bs." + this.type, f)
			}
		}
	...
	c.prototype.setContent = function() {
		...
		g.find(".popover-title")[this.options.html ? "html" : "text"](f);g.find(".popover-content").children().detach().end()[this.options.html ? (typeof e == "string" ? "html" : "append") : "text"](e);g.removeClass("fade top bottom left right in");
	...
	(function(e) {
				...
				h.fn[k] = function(p) {
					if (typeof p === "string") {
						...
						for (var q = 0, n = this.length; q < n; q++) {
							...
							var m = h.data(s, k);
							if (!m) {
								g("cannot call methods on " + k + " prior to initialization; " + "attempted to call '" + p + "'");continue
							}
							if (!h.isFunction(m[p]) || p.charAt(0) === "_") {
								g("no such method '" + p + "' for " + k + " instance");continue
							}
							var r = m[p].apply(m, o);
							if (r !== undefined && r !== m) {
								return r
						...
						var t = this.map(function() {
							...
							if (u) {
								...
								u = new l(this, p);h.data(this, k, u)
							}
							return h(this)
						});
						if (!t || t.length > 1) {
		...
		function c(k, m) {
			...
			if (this.sliderElem) {
				...
				u.className = "slider-handle max-slider-handle";g.appendChild(n);g.appendChild(h);g.appendChild(u);
				var p = function(B) {
					var C = document.createElement("div");
					C.className = "tooltip-arrow";
					var i = document.createElement("div");
					i.className = "tooltip-inner";B.appendChild(C);B.appendChild(i)
				};
				var q = document.createElement("div");
				q.className = "tooltip tooltip-main";p(q);
				var l = document.createElement("div");
				l.className = "tooltip tooltip-min";p(l);
				var o = document.createElement("div");
				o.className = "tooltip tooltip-max";p(o);this.sliderElem.appendChild(g);this.sliderElem.appendChild(q);this.sliderElem.appendChild(l);this.sliderElem.appendChild(o);s.insertBefore(this.sliderElem, this.element);
			...
			m = m ? m : {};var t = Object.keys(this.defaultOptions);
			...
			if (j === true) {
				this._removeClass(this.sliderElem, "slider-horizontal");this._removeClass(this.sliderElem, "slider-vertical");this._removeClass(this.tooltip, "hide");this._removeClass(this.tooltip_min, "hide");this._removeClass(this.tooltip_max, "hide");[ "left", "top", "width", "height" ].forEach(function(i) {
					this._removeProperty(this.trackSelection, i)
				}, this);[ this.handle1, this.handle2 ].forEach(function(i) {
					this._removeProperty(i, "left");this._removeProperty(i, "top")
				}, this);[ this.tooltip, this.tooltip_min, this.tooltip_max ].forEach(function(i) {
					this._removeProperty(i, "left");this._removeProperty(i, "top");this._removeProperty(i, "margin-left");this._removeProperty(i, "margin-top");this._removeClass(i, "right");this._removeClass(i, "top")
				}, this)
			}
			if (this.options.orientation === "vertical") {
				...
				this.stylePos = "top";
				this.mousePos = "pageY";
				this.sizePos = "offsetHeight";this._addClass(this.tooltip, "right");
				this.tooltip.style.left = "100%";this._addClass(this.tooltip_min, "right");
				this.tooltip_min.style.left = "100%";this._addClass(this.tooltip_max, "right");
				...
				this.stylePos = "left";
				this.mousePos = "pageX";
				this.sizePos = "offsetWidth";this._addClass(this.tooltip, "top");
			...
			if (j === true) {
				this._removeClass(this.handle1, "round triangle");this._removeClass(this.handle2, "round triangle hide")
			}
			var y = [ "round", "triangle", "custom" ];
			var w = y.indexOf(this.options.handle) !== -1;
			if (w) {
				this._addClass(this.handle1, this.options.handle);this._addClass(this.handle2, this.options.handle)
			}
			this.offset = this._offset(this.sliderElem);
			this.size = this.sliderElem[this.sizePos];this.setValue(this.options.value);
			this.handle1Keydown = this._keydown.bind(this, 0);this.handle1.addEventListener("keydown", this.handle1Keydown, false);
			this.handle2Keydown = this._keydown.bind(this, 1);this.handle2.addEventListener("keydown", this.handle2Keydown, false);
			if (this.touchCapable) {
				this.mousedown = this._mousedown.bind(this);this.sliderElem.addEventListener("touchstart", this.mousedown, false)
			} else {
				this.mousedown = this._mousedown.bind(this);this.sliderElem.addEventListener("mousedown", this.mousedown, false)
			}
			if (this.options.tooltip === "hide") {
				...
				if (this.options.tooltip === "always") {
					...
					this.hideTooltip = this._hideTooltip.bind(this);this.sliderElem.addEventListener("mouseenter", this.showTooltip, false);this.sliderElem.addEventListener("mouseleave", this.hideTooltip, false);this.handle1.addEventListener("focus", this.showTooltip, false);this.handle1.addEventListener("blur", this.hideTooltip, false);this.handle2.addEventListener("focus", this.showTooltip, false);this.handle2.addEventListener("blur", this.hideTooltip, false)
				}
			}
		...
		a.prototype = {
			...
			setValue : function(k, i) {
				...
				if (this.options.range) {
					...
					this.options.value = [ Math.max(this.options.min, Math.min(this.options.max, this.options.value)) ];this._addClass(this.handle2, "hide");
				...
				this._setDataVal(j);return this
			},
			destroy : function() {
			...
			disable : function() {
				this.options.enabled = false;this.handle1.removeAttribute("tabindex");this.handle2.removeAttribute("tabindex");this._addClass(this.sliderElem, "slider-disabled");this._trigger("slideDisabled");return this
			},
			enable : function() {
				this.options.enabled = true;this.handle1.setAttribute("tabindex", 0);this.handle2.setAttribute("tabindex", 0);this._removeClass(this.sliderElem, "slider-disabled");this._trigger("slideEnabled");return this
			},
			toggle : function() {
				if (this.options.enabled) {
					this.disable()
			...
			on : function(g, h) {
				if (e) {
					this.$element.on(g, h);this.$sliderElem.on(g, h)
				} else {
			...
			setAttribute : function(g, h) {
				this.options[g] = h;return this
			},
			refresh : function() {
				this._removeSliderEventHandlers();c.call(this, this.element, this.options);
				if (e) {
			...
			relayout : function() {
				this._layout();return this
			},
			_removeSliderEventHandlers : function() {
				this.handle1.removeEventListener("keydown", this.handle1Keydown, false);this.handle1.removeEventListener("focus", this.showTooltip, false);this.handle1.removeEventListener("blur", this.hideTooltip, false);this.handle2.removeEventListener("keydown", this.handle2Keydown, false);this.handle2.removeEventListener("focus", this.handle2Keydown, false);this.handle2.removeEventListener("blur", this.handle2Keydown, false);this.sliderElem.removeEventListener("mouseenter", this.showTooltip, false);this.sliderElem.removeEventListener("mouseleave", this.hideTooltip, false);this.sliderElem.removeEventListener("touchstart", this.mousedown, false);this.sliderElem.removeEventListener("mousedown", this.mousedown, false)
			},
			...
			_showTooltip : function() {
				if (this.options.tooltip_split === false) {
					...
					this._addClass(this.tooltip_min, "in");this._addClass(this.tooltip_max, "in")
				}
				this.over = true
			},
			...
			_layout : function() {
				...
				if (this.options.orientation === "vertical") {
					...
					if (k.right > h.left) {
						this._removeClass(this.tooltip_max, "top");this._addClass(this.tooltip_max, "bottom");
						this.tooltip_max.style.top = 18 + "px"
					} else {
						this._removeClass(this.tooltip_max, "bottom");this._addClass(this.tooltip_max, "top");
						this.tooltip_max.style.top = this.tooltip_min.style.top
					}
				}
				var j;
				if (this.options.range) {
					j = this.options.formatter(this.options.value);this._setText(this.tooltipInner, j);
					...
					j = this.options.formatter(this.options.value[0]);this._setText(this.tooltipInner, j);
			...
			_mousedown : function(h) {
				...
				this.percentage[this.dragged] = this.options.reversed ? 100 - g : g;this._layout();
				if (this.touchCapable) {
					document.removeEventListener("touchmove", this.mousemove, false);document.removeEventListener("touchend", this.mouseup, false)
				}
				if (this.mousemove) {
				...
				if (this.touchCapable) {
					document.addEventListener("touchmove", this.mousemove, false);document.addEventListener("touchend", this.mouseup, false)
				}
				document.addEventListener("mousemove", this.mousemove, false);document.addEventListener("mouseup", this.mouseup, false);
				this.inDrag = true;
				var i = this._calculateValue();
				this._trigger("slideStart", i);this._setDataVal(i);this.setValue(i);this._pauseEvent(h);return true
			},
			...
			_keydown : function(l, k) {
				...
				this.dragged = l;this._adjustPercentageForRangeSliders(h);
				this.percentage[this.dragged] = h;this._layout();
				var m = this._calculateValue();
				this._trigger("slideStart", m);this._setDataVal(m);this.setValue(m, true);this._trigger("slideStop", m);this._setDataVal(m);this._pauseEvent(k);return false
			},
			...
			_mousemove : function(h) {
				...
				this.percentage[this.dragged] = this.options.reversed ? 100 - g : g;this._layout();
				var i = this._calculateValue();
				this.setValue(i, true);return false
			},
			...
			_mouseup : function() {
				...
				document.removeEventListener("mousemove", this.mousemove, false);document.removeEventListener("mouseup", this.mouseup, false);
				this.inDrag = false;
				if (this.over === false) {
					this._hideTooltip()
				}
				var g = this._calculateValue();
				this._layout();this._trigger("slideStop", g);this._setDataVal(g);return false
			},
			...
			_getPercentage : function(h) {
				...
				g = Math.round(g / this.percentage[2]) * this.percentage[2];return Math.max(0, Math.min(100, g))
			},
			_validateInputValue : function(g) {
				if (typeof g === "number") {
					...
					if (g instanceof Array) {
						this._validateArray(g);return g
					} else {
			...
			_setDataVal : function(h) {
				var g = "value: '" + h + "'";
				this.element.setAttribute("data", g);this.element.setAttribute("value", h)
			},
			...
			_triggerJQueryEvent : function(g, i) {
				...
				this.$element.trigger(h);this.$sliderElem.trigger(h)
			},
	...
	var i = function(l, k) {
		...
		this.datesDisabled = [];
		this.daysOfWeekDisabled = [];this.setStartDate(k.startDate || this.element.data("date-startdate"));this.setEndDate(k.endDate || this.element.data("date-enddate"));this.setDatesDisabled(k.datesDisabled || this.element.data("date-dates-disabled"));this.setDaysOfWeekDisabled(k.daysOfWeekDisabled || this.element.data("date-days-of-week-disabled"));this.setMinutesDisabled(k.minutesDisabled || this.element.data("date-minute-disabled"));this.setHoursDisabled(k.hoursDisabled || this.element.data("date-hour-disabled"));this.fillDow();this.fillMonths();this.update();this.showMode();
		if (this.isInline) {
			this.show()
		}
	};
	i.prototype = {
		...
		show : function(j) {
			...
			this.place();f(window).on("resize", f.proxy(this.place, this));
			if (j) {
		...
		hide : function(j) {
			...
			this.picker.hide();f(window).off("resize", this.place);
		...
		remove : function() {
			this._detachEvents();f(document).off("mousedown", this.clickedOutside);this.picker.remove();
			delete this.picker;
		...
		fill : function() {
			...
			this.picker.find("tfoot th.today").text(a[this.language].today || a["en"].today).toggle(this.todayBtn !== false);this.picker.find("tfoot th.clear").text(a[this.language].clear || a["en"].clear).toggle(this.clearBtn !== false);this.updateNavArrows();this.fillMonths();
			var K = h(u, I - 1, 28, 0, 0, 0, 0),
				C = g.getDaysInMonth(K.getUTCFullYear(), K.getUTCMonth());
			K.setUTCDate(C);K.setUTCDate(C - (K.getUTCDay() - this.weekStart + 7) % 7);
			var j = new Date(K);
			...
			for (var B = 0; B < 24; B++) {
				...
				if (this.showMeridian && a[this.language].meridiem.length == 2) {
					...
					t = F;
					w = (B % 12 ? B % 12 : 12);s.push('<span class="hour' + v + " hour_" + (B < 12 ? "am" : "pm") + '">' + w + "</span>");
					if (B == 23) {
						s.push("</fieldset>")
					}
				} else {
			...
			for (var B = 0; B < 60; B += this.minuteStep) {
				...
				if (this.showMeridian && a[this.language].meridiem.length == 2) {
					...
					t = F;
					w = (D % 12 ? D % 12 : 12);s.push('<span class="minute' + v + '">' + w + ":" + (B < 10 ? "0" + B : B) + "</span>");
					if (B == 59) {
						s.push("</fieldset>")
					}
				} else {
			...
			if (o.length == 1) {
				...
				case "th":
					...
					case "next":
						...
						this.viewMode = this.startViewMode;this.showMode(0);this._setDate(k);this.fill();
						if (this.autoclose) {
							this.hide()
						}
						break
					...
					if (!o.is(".disabled")) {
						...
						if (o.is(".month")) {
							...
							r = this.viewDate.getUTCDate();this.viewDate.setUTCMonth(p);this.element.trigger({
								type : "changeMonth",
								date : this.viewDate
							});
							...
							if (o.is(".year")) {
								this.viewDate.setUTCDate(1);
								q = parseInt(o.text(), 10) || 0;this.viewDate.setUTCFullYear(q);this.element.trigger({
									type : "changeYear",
									date : this.viewDate
								});
								...
								if (o.is(".hour")) {
									...
									this.viewDate.setUTCHours(s);this.element.trigger({
										type : "changeHour",
										date : this.viewDate
									});
									...
									if (o.is(".minute")) {
										l = parseInt(o.text().substr(o.text().indexOf(":") + 1), 10) || 0;this.viewDate.setUTCMinutes(l);this.element.trigger({
											type : "changeMinute",
											date : this.viewDate
										});
					...
					if (o.is(".day") && !o.is(".disabled")) {
						...
						this.viewDate.setUTCFullYear(q);this.viewDate.setUTCMonth(p, r);this.element.trigger({
							type : "changeDay",
							date : this.viewDate
						});
		...
		moveMinute : function(k, j) {
			...
			l.setUTCMinutes(l.getUTCMinutes() + (j * this.minuteStep));return l
		},
		moveHour : function(k, j) {
			...
			var l = new Date(k.valueOf());
			l.setUTCHours(l.getUTCHours() + j);return l
		},
		moveDate : function(k, j) {
			...
			var l = new Date(k.valueOf());
			l.setUTCDate(l.getUTCDate() + j);return l
		},
		...
		keydown : function(n) {
			...
			case 39:
				...
				k = n.keyCode == 37 ? -1 : 1;viewMode = this.viewMode;
				if (n.ctrlKey) {
					viewMode += 2
				} else {
					if (n.shiftKey) {
				...
				if (this.dateWithinRange(r)) {
					this.date = r;
					this.viewDate = j;this.setValue();this.update();n.preventDefault();
					p = true
				}
				break;case 38:
			case 40:
				...
				k = n.keyCode == 38 ? -1 : 1;viewMode = this.viewMode;
				if (n.ctrlKey) {
					viewMode += 2
				} else {
					if (n.shiftKey) {
		...
		var b = {
			init : function() {
				return this.each(function() {
					...
					m.append(f).append(o).append(l);p.find(">div").addClass(p.find("input").is(":checked") ? "switch-on" : "switch-off");
					...
					p.on("keydown", function(q) {
						if (q.keyCode === 32) {
							q.stopImmediatePropagation();q.preventDefault();k(a(q.target).find("span:first"))
						}
						...
						var q = a(this);
						d = false;r.preventDefault();r.stopImmediatePropagation();q.closest("div").removeClass("switch-animate");
						if (q.closest(".has-switch").is(".deactivate")) {
							...
							q.on("mousemove touchmove", function(x) {
								...
								var t = a(this),
									s = a(u.target),
									v = s.siblings("input");
								u.stopImmediatePropagation();u.preventDefault();t.unbind("mouseleave");
								if (d) {
									v.prop("checked", !(parseInt(t.parent().css("left")) < -25))
								} else {
									v.prop("checked", !v.is(":checked"))
								}
								d = false;v.trigger("change")
							});q.on("mouseleave", function(t) {
								var s = a(this),
									u = s.siblings("input");
								t.preventDefault();t.stopImmediatePropagation();s.unbind("mouseleave");s.trigger("mouseup");u.prop("checked", !(parseInt(s.parent().css("left")) < -25)).trigger("change")
							});q.on("mouseup", function(s) {
								s.stopImmediatePropagation();s.preventDefault();a(this).unbind("mousemove")
							})
						}
					})
				})
			...
			destroy : function() {
				...
				e = d.children();e.unwrap().unwrap();e.unbind("change");return e
			}
		};
		if (b[c]) {
